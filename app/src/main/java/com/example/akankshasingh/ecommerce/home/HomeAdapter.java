...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ViewHolder> {
    ...
    public HomeAdapter(Context context, List<CategoriesData> data, OnItemClickListener listener) {
        this.data = data;
    ...
    public interface OnItemClickListener {
        void onClick(CategoriesData Item);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void click(final CategoriesData cityListData, final OnItemClickListener listener) {
